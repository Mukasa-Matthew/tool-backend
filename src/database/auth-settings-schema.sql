...
-- Global authentication configuration for the LTS Portal
...
CREATE INDEX IF NOT EXISTS idx_user_sso_accounts_user_id ON user_sso_accounts(user_id);
CREATE INDEX IF NOT EXISTS idx_user_sso_accounts_provider_id ON user_sso_accounts(provider_id);
CREATE INDEX IF NOT EXISTS idx_password_history_user_id ON password_history(user_id);
CREATE INDEX IF NOT EXISTS idx_auth_settings_key ON auth_settings(setting_key);
